...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{linear\PYZus{}regression}\PY{p}{(}\PY{n}{variables}\PY{p}{,} \PY{n}{should\PYZus{}print}\PY{p}{:} \PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
...
Cell \textcolor{ansi-green-intense}{\textbf{In[209], line 9}}
\textcolor{ansi-green}{      6} results = []
\textcolor{ansi-green}{      8} for columns in power\_set\_nonempty:
\textcolor{ansi-green-intense}{\textbf{----> 9}}   mse = linear\_regression(columns)
\textcolor{ansi-green}{     10}   results.append(\{
\textcolor{ansi-green}{     11}     'columns': columns,
\textcolor{ansi-green}{     12}     'num\_vars': len(columns),
\textcolor{ansi-green}{     13}     'mse': mse
\textcolor{ansi-green}{     14}   \})

\textcolor{ansi-red-intense}{\textbf{TypeError}}: linear\_regression() missing 1 required positional argument: 'should\_print'
    \end{Verbatim}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Create a DataFrame from the results}
\PY{n}{results\PYZus{}df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{results}\PY{p}{)}
